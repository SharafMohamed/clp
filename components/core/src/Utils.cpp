...
void load_lexer_from_file (std::string schema_file_path,
    ...
    lexer.m_symbol_id[log_surgeon::cTokenDouble] = (int) log_surgeon::SymbolID::TokenDoubleId;
    ...
    lexer.m_id_symbol[(int) log_surgeon::SymbolID::TokenDoubleId] = log_surgeon::cTokenDouble;
